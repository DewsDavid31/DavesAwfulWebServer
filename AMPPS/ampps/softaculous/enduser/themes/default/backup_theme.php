...
global $insid, $backing, $software, $soft, $completed, $cur_backups, $remote_location, $backup_count_per_script, $backing_up, $backup_count_per_installation;
...
echo '<div class="bg backup-form"><br />
		...
		//Maximum Backup Limit per installation
		if(!empty($globals['max_insid_backups']) && $backup_count_per_installation >= $globals['max_insid_backups']){
			echo '<div class="row">
			<div class="col-12 my-2 text-center">
				<div class="alert alert-warning">
					<a href="#close" class="close" data-dismiss="alert" aria-label="close">&times;</a>
					<span>'.lang_vars($l['error_max_backup_insid'], array($globals['max_insid_backups'])).'</span>
				</div>
			</div>
		</div>';	
		} 
